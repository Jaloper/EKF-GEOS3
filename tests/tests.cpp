...
int VarEqn_02() {
    ...
    yPhi(1,1) = 5542555.93722861; yPhi(2,1) = 3213514.8673492; yPhi(3,1) = 3990892.97587685;
    yPhi(4,1) = 5394.06842166351; yPhi(5,1) = -2365.21337882342; yPhi(6,1) = -7061.84554200295;
    yPhi(7,1) = 1.0; yPhi(14,1) = 1.0; yPhi(21,1) = 1.0; yPhi(28,1) = 1.0; yPhi(35,1) = 1.0; yPhi(42,1) = 1.0;
	
    Matrix yPhip = VarEqn(x,yPhi);
	
	Matrix yPhip_R = zeros(n,1);
    yPhip_R(1,1) = 5394.06842166351;   yPhip_R(2,1) = -2365.21337882342;   yPhip_R(3,1) = -7061.84554200295;
    yPhip_R(4,1) = -5.1348367854085;  yPhip_R(5,1) = -2.97717622353621;    yPhip_R(6,1) = -3.70591776714204;
    yPhip_R(10,1) = 5.70032035795975e-07;  yPhip_R(11,1) = 8.67651593239316e-07;  yPhip_R(12,1) = 1.08169354007259e-06;
    yPhip_R(16,1) = 8.67651590574781e-07;   yPhip_R(17,1) = -4.23359106882515e-07;  yPhip_R(18,1) = 6.27183702306411e-07;
    yPhip_R(22,1) = 1.08169353651988e-06;  yPhip_R(23,1) = 6.27183704082768e-07;   yPhip_R(24,1) = -1.46672928913461e-07;
    yPhip_R(25,1) = 1.0; yPhip_R(32,1) = 1.0; yPhip_R(39,1) = 1.0;
...
int DEInteg_01() {
    ...
    Y0_apr(4) =  4645.04725161806;
	Y0_apr(5) = -2752.21591588204;
	Y0_apr(6) = -7507.99940987031; 
...
int DEInteg_02() {
    ...
    yPhi(1,1)  = 5542555.93722861; yPhi(2,1)  =  3213514.8673492;  yPhi(3,1)  =  3990892.97587685;
    yPhi(4,1)  = 5394.06842166351; yPhi(5,1)  = -2365.21337882342; yPhi(6,1)  = -7061.84554200295;
    yPhi(7,1)  = 1.0;              yPhi(14,1) =  1.0;              yPhi(21,1) =  1.0;
	yPhi(28,1) = 1.0;              yPhi(35,1) =  1.0;              yPhi(42,1) =  1.0;
    ...
    R(4, 1)  =  5199.63333072017; R(5, 1)  = -2474.43881538621; R(6, 1)  = -7195.16750655247;
    R(7, 1)  =  1.00041922218421; R(8, 1)  =  0.00059920593529; R(9, 1)  =  0.00073733436271;
    R(10, 1) =  2.3451159772e-05; R(11, 1) =  3.2524000570e-05; R(12, 1) =  3.9754699608e-05;
    R(13, 1) =  0.00059921075800; R(14, 1) =  0.99970377069244; R(15, 1) =  0.00041868781501;
    R(16, 1) =  3.2524653812e-05; R(17, 1) = -1.6185496657e-05; R(18, 1) =  2.2340599902e-05;
    R(19, 1) =  0.00073734401318; R(20, 1) =  0.00041868992697; R(21, 1) =  0.99987741328020;
    R(22, 1) =  3.9756006622e-05; R(23, 1) =  2.2340885866e-05; R(24, 1) = -7.2216752490e-06;
    R(25, 1) =  37.0053480735676; R(26, 1) =  0.00742079763261; R(27, 1) =  0.00907126696766;
    R(28, 1) =  1.00044810751589; R(29, 1) =  0.00060406127179; R(30, 1) =  0.00073344771547;
    R(31, 1) =  0.00742082743734; R(32, 1) =  36.9963058593911; R(33, 1) =  0.00509711969510;
    R(34, 1) =  0.00060406611697; R(35, 1) =  0.99969715852876; R(36, 1) =  0.00040782991851;
    R(37, 1) =  0.00907132660578; R(38, 1) =  0.00509713274145; R(39, 1) =  36.9983505101633;
