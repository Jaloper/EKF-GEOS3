...
int IERS_01() {
    ...
    eop(2, 1) = 0;       eop(2, 2) = 0;
    eop(3, 1) = 0;       eop(3, 2) = 0;
    eop(4, 1) = 59580;   eop(4, 2) = 59581;   // MJD
    eop(5, 1) = 0.034;   eop(5, 2) = 0.035;   // x_pole [arcsec]
    eop(6, 1) = 0.456;   eop(6, 2) = 0.457;   // y_pole [arcsec]
    eop(7, 1) = -0.1;    eop(7, 2) = -0.09;   // UT1-UTC [s]
    eop(8, 1) = 0.002;   eop(8, 2) = 0.0021;  // LOD [s]
    eop(9, 1) = 1.2;     eop(9, 2) = 1.21;    // dpsi [arcsec]
    eop(10, 1) = 0.5;    eop(10, 2) = 0.51;   // deps [arcsec]
    eop(11, 1) = 0.001;  eop(11, 2) = 0.0011; // dx_pole [arcsec]
    eop(12, 1) = 0.002;  eop(12, 2) = 0.0021; // dy_pole [arcsec]
    eop(13, 1) = 37.0;   eop(13, 2) = 37.0;   // TAI-UTC [s]
	
	double Mjd_UTC = 59580.5;
	std::tuple<double, double, double, double, double, double, double, double, double> result = 
    IERS(eop, Mjd_UTC, 'l');
	double x_pole, y_pole, UT1_UTC, LOD, dpsi, deps, dx_pole, dy_pole, TAI_UTC;
	std::tie(x_pole, y_pole, UT1_UTC, LOD, dpsi, deps, dx_pole, dy_pole, TAI_UTC) = result;
	
	double R_x_pole=1.67261e-07;
	double R_y_pole=2.2132e-06;
	double R_UT1_UTC=-0.095;
	double R_LOD=0.00205;
	double R_dpsi=5.842e-06;
	double R_deps=2.4483e-06;
	double R_dx_pole=5.0905e-09;
	double R_dy_pole=9.9387e-09;
	double R_TAI_UTC=37;
	...
	ASSERT_CLOSE(dx_pole,R_dx_pole);
	ASSERT_CLOSE(dy_pole,R_dy_pole);
